            ...
            <div class="profile-wrapper wow fadeInRight" data-wow-delay="0.3s">
              ...
              <div class="about-profile">
                <ul class="admin-profile">
                  ...
                  <li><span class="pro-title"> Telefone </span> <span class="pro-detail"><%=rs("curriculo")%></span></li>
              ...
              <div class="about-profile">
                <ul class="admin-profile">
                  ...
                  <li>
                    ...
                    <span class="pro-detail"><a href="../upload/<%=rs("anexo")%>" target="blank"> Link anexo </a></span>
                  </li>
                  <% 
                    rs.movenext
                    loop
